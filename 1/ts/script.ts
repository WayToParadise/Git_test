...
enum Color { Black = "Чёрный", Gray = "Серый", Pink = "Розовый", Blue = "Синий", Yellow = "Желтый" };
...
let productList: Product[] = [
    ...
    new FeltBoots(1, "Timberlend", 91.2, "Хороший выбор! В них тепло, хорошо. Обувь многосезонная - лето, осень, зима, весна.", 6,
    ...
    new FeltBoots(7, "Валенки F10", 666.66, "Валенки великолепной работы слепого мастера Игната! В комплекте к валенкам идёт кокошник.", 2,
